...
<div class="split right" style="align-content: center">
    <form action="<%=request.getContextPath()%> /edit_receptionist" method="post"  >
        <div class="wrapper">
            <div class="title">
            ...
            <div class="form">
                ...
                <div class="inputfield">
                    ...
                    <input name="specification" type="text" class="input" value="${specification}">
                </div>
                <div class="inputfield">
                    <label>Qualification</label>
                    <input name="qualification" type="text" class="input" value="${qualification}">
                </div>
                <div class="inputfield">
                    <label>Hiring Date</label>
                    <input name="hiringdate" type="date" class="input" value="${hiringdate}">
                </div>
                <div class="inputfield">
